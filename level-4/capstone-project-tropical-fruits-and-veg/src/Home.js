...
function Home() {
    ...
    return (
        <div className="maxWidthContainer">
            ...
            <p className={`${theme} homeContent`}><span class="boldText">Click on one of the plants</span> in the list to be taken to a separate page that contains more information about the plant.</p>
